...
#-----------
ret_stat=$(ps -ef | grep -v 'grep' | grep PMD_to_MDB_pims.ksh | wc -l | awk '{print $1}')
...
export MDB_USERID MDB_PASS MDB_DBSTRING MDB_DBNAME

TNS_ADMIN=/var/opt/oracle; export TNS_ADMIN
PATH=$ORACLE_HOME/bin:/bin:/usr/bin:/etc; export PATH
LD_LIBRARY_PATH=$ORACLE_HOME/lib; export LD_LIBRARY_PATH 

$HOME/dba/bin/pmd_to_mdb_update
